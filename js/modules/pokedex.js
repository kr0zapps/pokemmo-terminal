        ...
        <div id="view-pokedex" class="hidden animate-fade-in">
            ...
            <div class="flex flex-col gap-4 mb-6">
                ...
                <div class="flex flex-wrap items-center justify-between gap-4">
                    <div id="regiónTabs" class="flex gap-1.5 overflow-x-auto pb-1 bg-[#EDE8DC] dark:bg-[#242420] border-2 border-[#2B2B2B] dark:border-[#35352E] p-1 rounded-xl w-full sm:w-auto max-w-full no-scrollbar">
                        <button onclick="window.pokedex.setRegion('Kanto')" id="reg-Kanto" class="px-3.5 py-2 min-h-[44px] text-[13px] font-tech font-bold uppercase tracking-wider bg-[#EDE8DC] dark:bg-[#2E2E27] text-[#1C1C17] dark:text-[#F4F1E8] rounded-lg border border-[#2B2B2B] dark:border-[#35352E] shadow-sm transition cursor-pointer flex items-center justify-center">Kanto</button>
